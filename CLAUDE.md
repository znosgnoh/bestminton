...
- **Timezone:** UI dates/times use the **viewer’s local timezone**. Match scheduling inputs, emails, Splitwise date labels, and server weekday logic use **Asia/Singapore** (`lib/datetime.ts`). Stored values remain UTC ISO.
